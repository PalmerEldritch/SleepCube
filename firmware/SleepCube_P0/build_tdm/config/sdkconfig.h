...
#define CONFIG_SC_BOARD_WAVESHARE_ESP32C6 1
#define CONFIG_SC_ENABLE_AUDIO 1
#define CONFIG_SC_AUDIO_I2S_MODE_TDM8 1
#define CONFIG_SC_AUDIO_I2S_FRAMING_PHILIPS 1
#define CONFIG_SC_AUDIO_HPF_CUTOFF_HZ 0
#define CONFIG_SC_AUDIO_HPF_STAGES 2
#define CONFIG_SC_AUDIO_SOURCE_MP3 1
#define CONFIG_SC_AUDIO_DIAG_SERIAL_CONSOLE 1
