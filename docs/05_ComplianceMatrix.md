...
| FR-SC-02 | The device shall operate on a stable flat surface such as a bedside table. |  | No TRS Derived From mapping found. | GAP |
...
| FR-A-02 | The device shall automatically loop its available audio content. |  | No TRS Derived From mapping found. | GAP |
| FR-A-03 | The device shall not require user track selection. |  | No TRS Derived From mapping found. | GAP |
| FR-A-04 | Playback shall occur without audible glitches, interruptions, or unintended artifacts. |  | No TRS Derived From mapping found. | GAP |
| FR-A-05 | The user shall be able to start audio playback using a physical control. |  | No TRS Derived From mapping found. | GAP |
| FR-A-06 | The user shall be able to stop audio playback using a physical control. |  | No TRS Derived From mapping found. | GAP |
...
| FR-A-10 | The device shall allow the user to increase playback volume. |  | No TRS Derived From mapping found. | GAP |
| FR-A-11 | The device shall allow the user to decrease playback volume. |  | No TRS Derived From mapping found. | GAP |
...
| FR-A-13 | Volume changes shall occur smoothly without abrupt steps. |  | No TRS Derived From mapping found. | GAP |
...
| FR-A-16 | Audio playback shall always operate with an active sleep timer. |  | No TRS Derived From mapping found. | GAP |
| FR-A-17 | The sleep timer duration shall be predefined. | TR-A-07, TR-A-08 | Mapped from TRS Derived From references. | OK |
| FR-A-18 | The user shall not be able to disable the sleep timer for continuous playback. |  | No TRS Derived From mapping found. | GAP |
...
| FR-L-04 | The device shall allow the user to adjust brightness. |  | No TRS Derived From mapping found. | GAP |
...
| FR-UI-02 | The number of user-facing controls shall be minimal. |  | No TRS Derived From mapping found. | GAP |
| FR-UI-03 | The device shall provide controls for: |  | No TRS Derived From mapping found. | GAP |
| FR-UI-04 | The sleep timer shall activate automatically when audio playback starts. |  | No TRS Derived From mapping found. | GAP |
| FR-UI-05 | The device shall not require a display. |  | No TRS Derived From mapping found. | GAP |
...
| FR-P-05 | The device shall not produce unintended sound or light during power-up. |  | No TRS Derived From mapping found. | GAP |
...
| FR-M-01 | The device shall have a cubic form factor. |  | No TRS Derived From mapping found. | GAP |
| FR-M-02 | Each side length shall be within approximately 50–100 mm. |  | No TRS Derived From mapping found. | GAP |
| FR-M-03 | The enclosure shall diffuse light to avoid direct glare. |  | No TRS Derived From mapping found. | GAP |
| FR-M-04 | The device shall be stable when placed on a flat surface. |  | No TRS Derived From mapping found. | GAP |
| FR-M-05 | The device shall not include bright status indicators visible during sleep use. |  | No TRS Derived From mapping found. | GAP |
